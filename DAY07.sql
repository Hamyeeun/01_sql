...
----------------------------------------------------------------
TO_CHAR() : 다른 타입에서 문자 타입으로 변환해 주는 함수
            숫자, 날짜 ==> 문자
...
SELECT '2019-5월-28'+ 10 "today(날짜) + 10일"
  FROM dual
;
...
SELECT e.empno
      ...
      ,DECODE(e.job,'CLERK', e.sal * 0.05
                    ...
                    ,'MANAGER', e.sal * 0.037
                    ,'ANALYST', e.sal * 0.03
                    ,'PRESIDENT', e.sal * 0.015) AS "경조사 지원금"
  FROM emp e
;
